...
//    protected fun showAlertDialog(msg: String, listener: View.OnClickListener?, isCancelable: Boolean = true): AlertDialogFragment {
//        return AlertDialogFragment.newInstance(msg, listener, isCancelable).also {
//            it.show(childFragmentManager, AlertDialogFragment.TAG)
//        }
//    }
}